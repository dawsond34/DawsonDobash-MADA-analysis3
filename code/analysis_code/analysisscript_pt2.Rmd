...
Nausea_aug1 %>% roc_curve(truth = Nausea, .pred_No) %>% autoplot()
Nausea_aug1 %>% roc_auc(truth = Nausea, .pred_No)

#Using the training data set
Nausea_aug2 = augment(Nausea_fit, training)
Nausea_aug2 %>% roc_curve(truth = Nausea, .pred_No) %>% autoplot()
Nausea_aug2 %>% roc_auc(truth = Nausea, .pred_No)
```
...
#Using the test data set
Nausea_aug3 %>% roc_curve(truth = Nausea, .pred_No) %>% autoplot()
Nausea_aug3 %>% roc_auc(truth = Nausea, .pred_No)

#Using the training data set
Nausea_aug4 = augment(Nausea_fit2, training)
Nausea_aug4 %>% roc_curve(truth = Nausea, .pred_No) %>% autoplot()
Nausea_aug4 %>% roc_auc(truth = Nausea, .pred_No)
```
